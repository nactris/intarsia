package dot.funky.intarsia.client.renderers;
...
public class AmethystGolemRenderer extends MobRenderer<AmethystGolem, AmethystGolemModel<AmethystGolem>> {
    ...
    public ResourceLocation getTextureLocation(AmethystGolem entity) {
        return  entity.isSinging() ? new ResourceLocation(Intarsia.MODID, "textures/entity/amethyst_golem/amethyst_golem_sing.png") : new ResourceLocation(Intarsia.MODID, "textures/entity/amethyst_golem/amethyst_golem.png");
    }

    private static class BudLayer extends RenderLayer<AmethystGolem, AmethystGolemModel<AmethystGolem>>{
        private static final ResourceLocation[] TEXTURE_LOCATION = new ResourceLocation[]{new ResourceLocation(Intarsia.MODID,"textures/entity/amethyst_golem/bud/small.png"), new ResourceLocation(Intarsia.MODID,"textures/entity/amethyst_golem/bud/medium.png"), new ResourceLocation(Intarsia.MODID,"textures/entity/amethyst_golem/bud/large.png"), new ResourceLocation(Intarsia.MODID,"textures/entity/amethyst_golem/bud/full.png")};
