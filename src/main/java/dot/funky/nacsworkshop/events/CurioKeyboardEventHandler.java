...
import dot.funky.nacsworkshop.common.network.CurioSlotCastHexPacket;
...
public class CurioKeyboardEventHandler {
    ...
    public static final String CATEGORY = "key.category.nacsworkshop";
            ...
            for (int i = 0; i < 5; i++) {
              //  NacsWorkshop.LOGGER.info("tick: {}", i);
                ...
                if (slotKeyDown[i] && isGameFocused && slotKeyAllowed[i]) {
                    ...
                    NacsPacketHandler.INSTANCE.sendToServer(new CurioSlotCastHexPacket(i));
